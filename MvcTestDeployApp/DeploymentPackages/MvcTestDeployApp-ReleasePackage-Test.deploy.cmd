...
set _DeploySetParametersFile=%RootPath%MvcTestDeployApp-ReleasePackage-Test.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MvcTestDeployApp-ReleasePackage-Test.zip" (
echo "%RootPath%MvcTestDeployApp-ReleasePackage-Test.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MvcTestDeployApp-ReleasePackage-Test.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='MvcTestDeployApp\\App_Data$'
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MvcTestDeployApp-ReleasePackage-Test.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='MvcTestDeployApp\\App_Data$' -setParamFile:"%_DeploySetParametersFile%"
)
...
start notepad "%RootPath%MvcTestDeployApp-ReleasePackage-Test.deploy-readme.txt"
)
echo =========================================================
goto :eof
