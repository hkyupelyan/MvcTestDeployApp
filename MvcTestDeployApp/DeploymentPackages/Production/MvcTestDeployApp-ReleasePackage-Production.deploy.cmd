...
set _DeploySetParametersFile=%RootPath%MvcTestDeployApp-ReleasePackage-Production.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MvcTestDeployApp-ReleasePackage-Production.zip" (
echo "%RootPath%MvcTestDeployApp-ReleasePackage-Production.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MvcTestDeployApp-ReleasePackage-Production.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\Release\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='MvcTestDeployApp\\App_Data$'
) else (
...
:usage
echo =========================================================
if not exist "%RootPath%MvcTestDeployApp-ReleasePackage-Production.deploy-readme.txt" (
...
start notepad "%RootPath%MvcTestDeployApp-ReleasePackage-Production.deploy-readme.txt"
)
echo =========================================================
goto :eof
